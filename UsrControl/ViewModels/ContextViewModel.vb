...
Public Class ContextViewModel
    ...
    Public Sub LoadCharts(ByVal IdModPozo As String)
        ...
        If mod_general IsNot Nothing Then
    ...
    Public Sub LoadConfig()
        ...
        Datgendate = IIf(VwGeneral.DATGENDATE Is Nothing, DateTime.Now, VwGeneral.DATGENDATE.GetValueOrDefault())
        TempModel = VwGeneral.TEMPMODEL.GetValueOrDefault()
        IprMethod = VwGeneral.IPRMETHOD
        ...
        Thpd = VwGeneral.THPD
        Thtd = VwGeneral.THTD
        'Trpres = VwGeneral.TRPRES.GetValueOrDefault()
        ...
        Select Case LiftMethod
            Case 1
                ModBNC = db.MOD_POZO_BNC.Where(Function(w) w.IDMODPOZO = VwGeneral.IDMODPOZO).SingleOrDefault()
            ...
            Case 2
                ModBEC = db.MOD_POZO_BEC.Where(Function(w) w.IDMODPOZO = VwGeneral.IDMODPOZO).SingleOrDefault()
    ...
    Private Sub LoadAgujero()
        ' ModBEC = New MOD_POZO_BEC()
        ' ModBNC = New MOD_POZO_BNC()
        Configuraciones = db.VW_MOD_POZO.Where(Function(w) w.IDAGUJERO = IdAgujero And w.ESTATUS = 3).OrderBy(Function(o) o.FECHAMODELO).ToList()
        Estatus = 0
        ...
        If AgujeroModel.IdModPozo IsNot Nothing Then
            ...
            VwGeneral = AgujeroModel.VWGeneral
            LoadConfig()
            ...
            If Estatus = 1 Then
                Prog = "Programado: " + VwGeneral.FECHA_PROGRAMACION
            End If
        Else
        ...
        Aforos = db.AFORO.Where(Function(w) w.ENDRECORD = Nothing And w.IDAGUJERO = AgujeroModel.IdAgujero).ToList()
...
#End Region
    ...
    Private Sub OnSave()
        ...
        Try
            ...
            If AgujeroModel.IdModPozo IsNot Nothing AndAlso AgujeroModel.Estatus = 0 Then
    ...
    Public Function SaveGeneral(ByVal ModPozo As MOD_POZO) As Boolean
        Try
            ...
            If ModGeneral IsNot Nothing Then

                'Cargamos nuevamente los parametros
                ' ModGeneral.IDMODPOZO = AgujeroModel.IdModPozo
                ' ModGeneral.IDMODPOZOGENERAL = Exists.IDMODPOZOGENERAL
                LoadDefault()
                LoadGeneral()
                'ModGeneral.FLUID = Fluid
                'ModGeneral.OUTPUTRES = OutputRes
    ...
    Private Function SaveTemperatura(ByVal ModPozo As MOD_POZO, ByVal puntos(,) As Double) As Boolean
        Try
            ...
            Return True
        Catch ex As Exception
            MsgBox("Error en datos de formación:" & IdAgujero & " - " & FechaPrueba)
            Return False
        End Try
    End Function
